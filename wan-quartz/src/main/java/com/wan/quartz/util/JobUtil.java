...
public class JobUtil {
	...
	public static void createScheduleJob(Scheduler scheduler, SysJob quartzBean) throws ClassNotFoundException, SchedulerException {
        ...
        if ("0".equals(quartzBean.getStatus())) {
        	pauseScheduleJob(scheduler, quartzBean.getJobName());
        }
    }
     ...
     * @throws SchedulerException
     */
    public static void updateScheduleJob(Scheduler scheduler, SysJob quartzBean) throws SchedulerException  {
        //获取到对应任务的触发器
